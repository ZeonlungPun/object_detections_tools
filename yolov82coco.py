...
classes = ['corn','sorghum','soybean','wheat'] # 这里改一下

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='/home/kingargroo/seed/experiment_data/4/images/test', type=str, help="path of images")  # 图片路径改一下
parser.add_argument('--label_path', default='/home/kingargroo/seed/experiment_data/4/labels/test', type=str, help="path of labels .txt")  # 图片标签路径改一下
parser.add_argument('--save_path', type=str, default='/home/kingargroo/seed/experiment_data/4/val.json',
