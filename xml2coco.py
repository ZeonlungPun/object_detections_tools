...
def img_change(img_path_list,dst_path):
    for img_path in img_path_list:
        name=os.path.basename(img_path.replace('xml', 'jpg'))
        img_path_=os.path.join('.\\JPEGImages',name)
        shutil.copy(img_path_,dst_path+ '\\' + name)
...
if __name__ == '__main__':
    ...
    img_change(xml_list_train, './train2017')
    img_change(xml_list_val,'./val2017')
