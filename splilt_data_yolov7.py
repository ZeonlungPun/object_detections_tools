#splict the data into train,test and validate
import shutil
import random
import os
 
# 原始路径
image_original_path = r"/home/kingargroo/seed/voc/train/images/"
label_original_path = r"/home/kingargroo/seed/voc/train/labels/"
...
def main():
    ...
    print("num of train set：{}, num of validate：{}, num of test：{}".format(len(train), len(val), len(val_test) - len(val)))
